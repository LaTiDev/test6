...
@section('title','TEST6 | Thùng rác')
<section class="content">

    <!-- Default box -->
    <div class="col-xs-12">
      <h1 class="text-center">Danh sách đã xóa</h1>
        <div class="box">
                ...
                @forelse ($categories as $item)
                  <tr class="text-center">
                    ...
                    <td>
                      ...
                      <a href="{{route('category.forceDelete',$item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa vĩnh viễn ?')" class="btn btn-danger">Xóa vĩnh viễn</a>
                    </td>
                  </tr>
                @empty
